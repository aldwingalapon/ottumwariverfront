...
if ( ! class_exists( 'Innomerce_Blog_Layouts_Module' ) ) {

	/**
	 * Define Innomerce_Blog_Layouts_Module class
	 */
	class Innomerce_Blog_Layouts_Module extends Innomerce_Module_Base {
		/**
		 * properties.
		 */
		private $layout_type;
		...
		public function filters() {
			...
			add_filter( 'innomerce-theme/customizer/options', array( $this, 'customizer_options' ) );
			add_filter( 'innomerce-theme/customizer/blog-sidebar-enabled', array( $this, 'customizer_blog_sidebar_enabled' ) );
			add_filter( 'innomerce-theme/posts/template-part-slug', array( $this, 'apply_layout_template' ) );
			add_filter( 'innomerce-theme/posts/post-style', array( $this, 'apply_style_template' ) );
			add_filter( 'innomerce-theme/posts/list-class', array( $this, 'add_list_class' ) );
			add_filter( 'innomerce-theme/site-content/container-enabled', array( $this, 'disable_site_content_container' ) );
		...
		public function module_init_properties() {
			...
			$this->layout_type  = innomerce_theme()->customizer->get_value( 'blog_layout_type' );
			$this->layout_style = innomerce_theme()->customizer->get_value( 'blog_style' );
		...
		public function customizer_options( $options ) {
			...
			$new_options = array(
				'blog_layout_type' => array(
					...
					'field'    => 'select',
					'choices'  => array(
						'default'          => esc_html__( 'Listing', 'innomerce' ),
						'grid'             => esc_html__( 'Grid', 'innomerce' ),
						'masonry'          => esc_html__( 'Masonry', 'innomerce' ),
						'vertical-justify' => esc_html__( 'Vertical Justify', 'innomerce' ),
						'creative'         => esc_html__( 'Creative', 'innomerce' ),
					),
					'type' => 'control',
				),
				'blog_style' => array(
					'title'    => esc_html__( 'Style', 'innomerce' ),
					'section'  => 'blog',
					'priority' => 2,
					'default'  => 'default',
					'field'    => 'select',
					'choices'  => array(
						'default' => esc_html__( 'Style 1', 'innomerce' ),
						'v2'      => esc_html__( 'Style 2', 'innomerce' ),
						'v3'      => esc_html__( 'Style 3', 'innomerce' ),
						'v4'      => esc_html__( 'Style 4', 'innomerce' ),
						'v5'      => esc_html__( 'Style 5', 'innomerce' ),
						'v6'      => esc_html__( 'Style 6', 'innomerce' ),
						'v7'      => esc_html__( 'Style 7', 'innomerce' ),
						'v8'      => esc_html__( 'Style 8', 'innomerce' ),
						'v9'      => esc_html__( 'Style 9', 'innomerce' ),
						'v10'     => esc_html__( 'Style 10', 'innomerce' ),
					),
					'type' => 'control',
				),
			);
