...
if ( ! class_exists( 'Innomerce_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Innomerce_Woo_Breadcrumbs_Module class
	 */
	class Innomerce_Woo_Breadcrumbs_Module extends Innomerce_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Innomerce_WC_Breadcrumbs( $args );
