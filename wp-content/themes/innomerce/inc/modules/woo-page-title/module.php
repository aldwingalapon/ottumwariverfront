...
if ( ! class_exists( 'Innomerce_Woo_Page_Title_Module' ) ) {

	/**
	 * Define Innomerce_Woo_Page_Title_Module class
	 */
	class Innomerce_Woo_Page_Title_Module extends Innomerce_Module_Base {
