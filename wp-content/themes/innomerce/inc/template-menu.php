...
function innomerce_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'innomerce-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'innomerce_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'innomerce' ),
			) );
 ...
 * @return void
 */
function innomerce_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'innomerce-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'innomerce' ),
		) );
 ...
 * @return string
 */
function innomerce_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'innomerce-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'innomerce_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'innomerce' ),
	), $context, $type );
 ...
 * @return void
 */
function innomerce_set_nav_menu( $args ) {
