...
if ( ! class_exists( 'Innomerce_Widget_Area' ) ) {

	class Innomerce_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'innomerce-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'innomerce-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'innomerce-theme/widget_area/classes', $classes, $area_id );
	...
	function innomerce_widget_area() {
		return Innomerce_Widget_Area::get_instance();
	}

	innomerce_widget_area();
}
